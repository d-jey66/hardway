...
export default function Location() {
  return (
    <div className="bg-gray-950 py-46 flex items-center overflow-hidden w-screen flex-col px-1 lg:flex-row gap-5 justify-center border-t-2 border-gray-900">
      ...
      <div className="h-120 max-w-120 flex flex-col rounded-2xl md:border-2 border-gray-800 bg-gray-950 items-start justify-center px-8 gap-6 md:h-150 md:w-150 md:max-w-150 md:px-12 md:gap-8">
